...
export default function Dashboard() {
  ...
  return (
    <main style={styles.container}>
      ...
      <AnimatePresence>
        {onboarding && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ position: 'fixed', inset: 0, background: '#0a0a0b', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
            <div style={{ maxWidth: '400px', width: '100%' }}>
              <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                <Shield size={64} color="#3b82f6" style={{ margin: '0 auto 1.5rem' }} />
                <h2 style={{ fontSize: '2rem', fontWeight: 900, textTransform: 'uppercase' }}>Initialize Base</h2>
      ...
      <AnimatePresence>
        {showEndDay && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.95)', backdropFilter: 'blur(20px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1.5rem' }}>
            <motion.div initial={{ scale: 0.9, y: 30 }} animate={{ scale: 1, y: 0 }} style={{ ...styles.glassCard, width: '100%', maxWidth: '400px', padding: '2rem', textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.25rem', fontWeight: 900, textTransform: 'uppercase', color: '#ef4444' }}>Mission Failure</h3>
              <p style={{ fontSize: '11px', color: '#444', marginTop: '0.5rem' }}>Incomplete objectives detected.</p>
              <textarea placeholder="Log the blocker..." value={reflection} onChange={(e) => setReflection(e.target.value)} style={{ width: '100%', height: '80px', background: 'rgba(255,255,255,0.05)', border: '1px solid #333', borderRadius: '12px', padding: '1rem', color: 'white', fontSize: '12px', marginTop: '1.5rem', outline: 'none' }} />
