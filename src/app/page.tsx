  ...
  return (
    <main style={styles.container}>
      <AnimatePresence mode="wait">
        {status === 'off-duty' ? (
          <motion.div key="off" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
